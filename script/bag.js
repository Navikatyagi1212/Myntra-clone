...
function displayBagSummary() {
  ...
  bagItemObjects.forEach((bagItems) => {
    ...
    totaDiscount += bagItems.original_price - bagItems.current_price;
  });

  let finalPayment = totalMRP - totaDiscount + CONVENIENCE_FEES;
  ...
  <div class="bag-details-container">
                        ...
                        <div class="price-item">
                            ...
                            <span
                                class="price-item-value priceDetail-base-discount">-Rs ${totaDiscount}</span>
                        </div>
                        <div class="price-item">
